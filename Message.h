...
public:
    enum MessageType {
        SETUP,      // To send initial information to the node.
    ...
    struct Setup {
        ...
        static Setup deserialize(const string &data);
    };
    ...
    Message(MessageType type, const Setup &Setup_Data);
